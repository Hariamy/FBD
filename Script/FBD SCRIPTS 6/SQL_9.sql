...
begin
	select P.Nome
	from Playlist P
	where P.Cod_playlist = @Cod_playlist and (
		...
		on PE.Cod_periodo = FC.Cod_periodo
		where F.TP_composicao = 'Concerto' and PE.Descricao = 'Barroco' and P.Cod_playlist = @Cod_playlist)
	)
end
