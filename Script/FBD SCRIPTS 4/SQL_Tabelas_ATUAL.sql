...
create table Playlist(
	...
	Tempo_execucao int not null, --saiu da relação
...
create table Faixa(
	...
	constraint FK_Cod_album foreign key(Cod_album) references Album
	on delete cascade
	on update cascade,
...
create table AlbumFaixa(
	...
	on delete cascade --deveria apagar todas as referecnias do album nesta tabela
	on update no action,
